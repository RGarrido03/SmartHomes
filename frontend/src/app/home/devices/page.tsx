...
type Device = {
  name: string,
  type:'TV' | 'SOLARPV' | 'WINDTURBINE' | 'PLUG' | 'GRIDMETER' | 'AC' | 'LIGHT' | 'SMARTASSISTANT' | 'CARCARGER' | 'VACUUM' | 'DESUMIDIFIER'| 'OVEN',
  on: boolean
};
...
export default function Devices(){
    ...
    return <div className="grid grid-flow-row grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        <TitleCard text="Check your devices per room."/>
